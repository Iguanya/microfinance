<?PHP
        ...
        if(isset($_POST['login'])){
                ...
                $query_log = db_query($db_link, $sql_log);
                checkSQL($db_link, $query_log);
                $result_log = db_fetch_assoc($query_log);
                ...
                if(password_verify($log_pw.$pepper, $result_log['user_pw'])){
                        ...
                        $query_logout = db_query($db_link, $sql_logout);
                        checkSQL($db_link, $query_logout);
                        $logout = db_fetch_array($query_logout);
                        ...
                        $query_close_logrec = db_query($db_link, $sql_close_logrec);
                        ...
                        $query_logrecid = db_query($db_link, $sql_logrecid);
                        checkSQL($db_link, $db_link, $query_logrecid);
                        $logrecid = db_fetch_array($query_logrecid);
