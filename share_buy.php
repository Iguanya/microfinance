...
if (isset($_POST['buy_shares'])) {
    ...
    if ($ss_amount <= 0) {
        ...
        $sql_insert = "INSERT INTO stakeholder_shares (stakeholder_id, ss_date, ss_type, ss_amount, ss_value, ss_receipt, ss_notes, ss_created, user_id) 
                       VALUES ('$stakeholder_id', '$ss_date', 'buy', '$ss_amount', '$ss_value', '$ss_receipt', '$ss_notes', $timestamp, '$_SESSION[log_id]')";
        ...
        if ($query_insert) {
            ...
            $error_message = 'Error recording share purchase: ' . db_error($db_link);
        }
    }
}
            ...
            <div class="row">
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h2><i class="fa fa-plus-circle"></i> Buy Shares</h2>
                    ...
                    <p class="lead">Purchase shares for <strong><?PHP echo $stakeholder['stakeholder_name']; ?> (<?PHP echo $stakeholder['stakeholder_no']; ?>)</strong></p>
                        ...
                        <div class="col-md-4">
                            <div class="card shadow-sm mb-4">
                                <div class="card-header bg-success text-white py-2">
                                    <h6 class="mb-0">Record Share Purchase</h6>
                                </div>
                                <div class="card-body">
                                    <form action="share_buy.php?sh=<?PHP echo $stakeholder_id; ?>" method="post">
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label for="ss_receipt" class="form-label fw-bold small">Receipt Number</label>
                                            <input type="text" class="form-control" id="ss_receipt" name="ss_receipt" />
                                        </div>

                                        <div class="mb-3">
                                            <label for="ss_amount" class="form-label fw-bold small">Number of Shares *</label>
                                        ...
                                        <div class="d-grid">
                                            <button type="submit" name="buy_shares" class="btn btn-success btn-lg">
