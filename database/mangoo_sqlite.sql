...
CREATE TABLE custmarried (
  custmarried_id INTEGER PRIMARY KEY AUTOINCREMENT,
  custmarried_status TEXT NOT NULL
);
...
CREATE TABLE customer (
  ...
  cust_no TEXT DEFAULT NULL,
  cust_name TEXT DEFAULT NULL,
  cust_dob INTEGER DEFAULT NULL,
  custsex_id INTEGER NOT NULL,
  cust_address TEXT DEFAULT NULL,
  cust_phone TEXT DEFAULT NULL,
  cust_email TEXT DEFAULT NULL,
  cust_occup TEXT DEFAULT NULL,
  custmarried_id INTEGER NOT NULL,
  cust_heir TEXT DEFAULT NULL,
  cust_heirrel TEXT DEFAULT NULL,
  cust_lengthres INTEGER DEFAULT NULL,
  cust_since INTEGER DEFAULT NULL,
  custsick_id INTEGER DEFAULT NULL,
  cust_lastsub INTEGER DEFAULT NULL,
  cust_active INTEGER NOT NULL DEFAULT '0',
  cust_lastupd INTEGER DEFAULT NULL,
  cust_pic TEXT DEFAULT NULL,
...
CREATE TABLE custsex (
  custsex_id INTEGER PRIMARY KEY AUTOINCREMENT,
  custsex_name TEXT DEFAULT NULL
);
...
CREATE TABLE custsick (
  custsick_id INTEGER PRIMARY KEY AUTOINCREMENT,
  custsick_name TEXT NOT NULL,
  custsick_risk INTEGER NOT NULL
);
...
CREATE TABLE emplmarried (
  emplmarried_id INTEGER PRIMARY KEY AUTOINCREMENT,
  emplmarried_status TEXT DEFAULT NULL
);
...
CREATE TABLE employee (
  ...
  empl_dob INTEGER DEFAULT NULL,
  emplsex_id INTEGER NOT NULL,
  emplmarried_id INTEGER NOT NULL,
  empl_position TEXT DEFAULT NULL,
  empl_salary INTEGER DEFAULT NULL,
  empl_address TEXT DEFAULT NULL,
  empl_phone TEXT DEFAULT NULL,
  empl_email TEXT DEFAULT NULL,
  empl_in INTEGER DEFAULT NULL,
  empl_out INTEGER DEFAULT NULL,
  empl_lastupd INTEGER DEFAULT NULL,
  empl_active INTEGER NOT NULL DEFAULT '0',
  empl_pic TEXT DEFAULT NULL,
  user_id INTEGER NOT NULL
);
...
CREATE TABLE emplsex (
  emplsex_id INTEGER PRIMARY KEY AUTOINCREMENT,
  emplsex_name TEXT DEFAULT NULL
);
...
CREATE TABLE expenses (
  ...
  exp_date INTEGER DEFAULT NULL,
  exp_text TEXT DEFAULT NULL,
  exp_recipient TEXT DEFAULT NULL,
  exp_receipt INTEGER DEFAULT NULL,
  exp_voucher INTEGER DEFAULT NULL,
  exp_created INTEGER DEFAULT NULL,
...
CREATE TABLE exptype (
  exptype_id INTEGER PRIMARY KEY AUTOINCREMENT,
  exptype_type TEXT NOT NULL,
  exptype_short TEXT NOT NULL
);
...
CREATE TABLE fees (
  ...
  fee_short TEXT NOT NULL,
  fee_value REAL DEFAULT NULL
);
...
CREATE TABLE incomes (
  ...
  ltrans_id INTEGER DEFAULT NULL,
  sav_id INTEGER DEFAULT NULL,
  inc_amount INTEGER NOT NULL,
  inc_date INTEGER NOT NULL,
  inc_receipt INTEGER NOT NULL,
  inc_text TEXT NOT NULL,
  inc_created INTEGER NOT NULL,
  user_id INTEGER NOT NULL
);
...
CREATE TABLE inctype (
  inctype_id INTEGER PRIMARY KEY AUTOINCREMENT,
  inctype_type TEXT NOT NULL,
  inctype_short TEXT NOT NULL
);
...
CREATE TABLE loans (
  ...
  loanstatus_id INTEGER NOT NULL,
  loan_no TEXT NOT NULL,
  loan_date INTEGER NOT NULL,
  loan_dateout INTEGER NOT NULL,
  loan_issued INTEGER NOT NULL,
  loan_principal INTEGER NOT NULL,
  loan_principalapproved INTEGER NOT NULL,
  loan_interest REAL NOT NULL,
  loan_appfee_receipt INTEGER NOT NULL,
  loan_fee INTEGER NOT NULL,
  loan_fee_receipt INTEGER NOT NULL,
  loan_insurance INTEGER NOT NULL,
  loan_insurance_receipt INTEGER NOT NULL,
  loan_rate decimal(11,0) NOT NULL,
  loan_period INTEGER NOT NULL,
  loan_repaytotal INTEGER NOT NULL,
  loan_purpose TEXT NOT NULL,
  loan_guarant1 INTEGER NOT NULL,
  loan_guarant2 INTEGER NOT NULL,
  loan_guarant3 INTEGER NOT NULL,
  loan_feepaid INTEGER NOT NULL DEFAULT '0',
  loan_created INTEGER DEFAULT NULL,
  loan_xtra1 TEXT DEFAULT NULL,
  loan_xtraFee1 INTEGER DEFAULT NULL,
  user_id INTEGER NOT NULL
);
...
CREATE TABLE loanstatus (
  loanstatus_id INTEGER PRIMARY KEY AUTOINCREMENT,
  loanstatus_status TEXT NOT NULL,
  loanstatus_short TEXT NOT NULL
);
...
CREATE TABLE logrec (
  logrec_id INTEGER PRIMARY KEY AUTOINCREMENT,
  user_id INTEGER DEFAULT NULL,
  logrec_start INTEGER DEFAULT NULL,
  logrec_end INTEGER DEFAULT NULL,
  logrec_logout INTEGER NOT NULL DEFAULT '0'
);
...
CREATE TABLE ltrans (
  ltrans_id INTEGER PRIMARY KEY AUTOINCREMENT,
  loan_id INTEGER NOT NULL,
  ltrans_due INTEGER DEFAULT NULL,
  ltrans_date INTEGER DEFAULT NULL,
  ltrans_principaldue INTEGER DEFAULT NULL,
  ltrans_principal INTEGER DEFAULT NULL,
  ltrans_interestdue INTEGER DEFAULT NULL,
  ltrans_interest INTEGER DEFAULT NULL,
  ltrans_fined INTEGER NOT NULL DEFAULT '0',
  ltrans_receipt INTEGER DEFAULT NULL,
  ltrans_created INTEGER DEFAULT NULL,
  user_id INTEGER NOT NULL
);
...
CREATE TABLE savbalance (
  savbal_id INTEGER PRIMARY KEY AUTOINCREMENT,
  cust_id INTEGER NOT NULL,
  savbal_balance INTEGER NOT NULL,
  savbal_fixed INTEGER NOT NULL,
  savbal_date INTEGER NOT NULL,
  savbal_created INTEGER NOT NULL,
  user_id INTEGER NOT NULL
);
...
CREATE TABLE savings (
  sav_id INTEGER PRIMARY KEY AUTOINCREMENT,
  savtype_id INTEGER NOT NULL,
  sav_mother INTEGER DEFAULT NULL,
  cust_id INTEGER NOT NULL,
  ltrans_id INTEGER DEFAULT NULL,
  sav_date INTEGER NOT NULL,
  sav_amount INTEGER NOT NULL DEFAULT '0',
  sav_receipt INTEGER DEFAULT NULL,
  sav_slip INTEGER NOT NULL,
  sav_payer TEXT DEFAULT NULL,
  sav_fixed INTEGER DEFAULT NULL,
  sav_created INTEGER DEFAULT NULL,
  user_id INTEGER NOT NULL
);
...
CREATE TABLE savtype (
  savtype_id INTEGER PRIMARY KEY AUTOINCREMENT,
  savtype_type TEXT NOT NULL,
  savtype_short TEXT NOT NULL
);
...
CREATE TABLE securities (
  ...
  sec_value INTEGER NOT NULL,
  sec_path TEXT NOT NULL,
  sec_returned INTEGER NOT NULL DEFAULT '0',
  sec_date INTEGER NOT NULL,
  sec_returned_date INTEGER NOT NULL,
  sec_lastupd INTEGER NOT NULL,
  user_id INTEGER NOT NULL
);
...
CREATE TABLE shares (
  ...
  share_receipt INTEGER NOT NULL,
  share_trans INTEGER NOT NULL,
  share_transfrom INTEGER DEFAULT NULL,
  share_created INTEGER DEFAULT NULL,
  user_id INTEGER NOT NULL
);
...
CREATE TABLE shareval (
  shareval_id INTEGER PRIMARY KEY AUTOINCREMENT,
  shareval_date INTEGER NOT NULL,
  shareval_value INTEGER NOT NULL
);
...
CREATE TABLE ugroup (
  ugroup_id INTEGER PRIMARY KEY AUTOINCREMENT,
  ugroup_name TEXT NOT NULL,
  ugroup_admin INTEGER NOT NULL,
  ugroup_delete INTEGER NOT NULL,
  ugroup_report INTEGER NOT NULL,
  ugroup_created INTEGER NOT NULL
);
