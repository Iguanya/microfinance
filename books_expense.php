                            ...
                            <div class="card-body">
                                <form action="books_expense.php" method="post">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="exptype_id" class="form-select">
                                            <?PHP
                                    ...
                                    <div class="d-grid">
                                        <button type="submit" name="expnew" class="btn btn-success btn-lg">Add Expense</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        while ($row_expcur = db_fetch_assoc($query_expcur)) {
                                            ...
                                            echo '<tr>      
                                                ...
                                                <td class="text-end">' . number_format($row_expcur['exp_amount']) . ' ' . $_SESSION['set_cur'] . '</td>
                                                <td>' . $exp_recipient . '</td>
